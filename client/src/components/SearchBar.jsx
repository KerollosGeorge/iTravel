...
export const SearchBar = () => {
  ...
  return (
    <div
      className={
        darkMode
          ? "w-full flex justify-center items-center mt-3 bg-[rgb(32,32,32)] rounded-md border-none outline-none shadow-xl"
          : "w-full flex justify-center items-center mt-3 bg-white rounded-md border-none outline-none shadow-xl"
      }
    >
      <div className=" w-[1000px] flex gap-0 rounded-md p-9 justify-around items-center max-md:w-[70%] max-md:flex max-md:flex-col max-md:gap-6 transition-all ">
        <input
          ...
          className={
            !err
              ? "outline-none indent-1 py-2 px-3 border-[1px] border-gray-800 rounded-sm bg-transparent"
              : " border-[1px] border-red-600 indent-1 py-2 px-3 placeholder-red-600"
          }
        ...
        <div className="relative">
          <span
            ...
            className=" cursor-pointer  text-gray-400 border-[1px] border-gray-800 p-2 "
          >
        ...
        <div className="relative ">
          <span
            ...
            className="cursor-pointer text-gray-400 border-[1px] border-gray-800 py-2 px-2 max-md:px-[5px]"
          >
