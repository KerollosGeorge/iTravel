    ...
    <div className=" w-ful flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          ...
          and conditions of your use of the [iTravel] website ("Website" or
          ...
          "you" or "your") and [iTravel] ("[iTravel]", "we", "us" or "our"). By
          ...
          contract between you and [iTravel], even though it is electronic and
          is not physically signed by you and [iTravel], and it governs your use
        ...
        <p className="mb-4">
          ...
          foregoing reasons, you may not re-register for the Services. We may
        ...
        <p className="mb-4">
          ...
          no obligation to, monitor and review Content on the Website submitted
          or created using our Services by you. You grant us permission to
          ...
          those representations or warranties, we have the right, though not the
          obligation, to, in our sole discretion, refuse or remove any Content
          that, in our reasonable opinion, violates any of our policies or is in
          any way harmful or objectionable.
        </p>
        <h2 className="text-2xl font-bold mb-4 mt-8">Billing and payments</h2>
        <p className="mb-4">
          ...
          charge is due and payable. Where Services are subject to a
          subscription period, you may be billed in advance on a recurring basis
          on the start date of each subscription period. If, in our judgment,
          your purchase constitutes a high-risk transaction, we will require you
          to provide us with a copy of your valid government-issued photo
          identification, and possibly acopy of a recent bank statement for the
          account used to purchase the Services. We reserve the right to change
          products and product pricing at any time. We also reserve the right to
        ...
        <p className="mb-4">
          We may, at any time and for any reason, terminate your access to the
          Services, terminate this Agreement, or suspend or terminate your
          account. In the event of termination, your account will be disabled
          and you may not be granted access to your account or any Content
          therein.
        </p>
        <h2 className="text-2xl font-bold mb-4 mt-8">
        ...
        <p className="mb-4">
          ...
          [iTravel] or its suppliers be liable for any special, incidental,
          ...
          inability to use the Services, third-party software and/or third-party
          hardware used with the Services, or otherwise in connection with any
          provision of this Agreement), even if [iTravel] or any supplier has
        ...
        <ul className="list-disc list-inside mb-4">
          <li>[iTravel]</li>
          <li>[iTravel.support@gmail.com]</li>
          <li>[01273201722]</li>
        </ul>
      </div>
    </div>
